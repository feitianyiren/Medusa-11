...
var Playing = function() {
    ...
    var clickProgressBar = function(event_, element) {
        ...
        var clickPosition = event_.pageX - (element.offsetLeft * shared.zoomFactor);
        var percentage = clickPosition / (barWidth * shared.zoomFactor);
    ...
    var updateTextBasic = function(data) {
        ...
        if (category === "television") {
            ...
            if (data["next"]) {
                textRight += Utilities.toHTML({
                    a: {
                        href: "/medusa/media/" + data["next"],
                        class: classes.nextEpisode,
                        content: "&rarr;"
                    }
                });
            }
